        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
            {[
              ...
              <div 
                key={i} 
                className={`relative p-5 bg-[#FDFBF7] border border-dashed border-accent-terracotta/20 rounded-sm shadow-md transition-all duration-700 hover:scale-105 flex flex-col items-center gap-2 ${
                  i % 3 === 0 ? 'rotate-1' : i % 3 === 1 ? '-rotate-1' : 'rotate-2'
                }`}
              >
                {/* Vintage Tape Effect */}
                <div className="absolute -top-2 left-1/2 -translate-x-1/2 w-8 h-4 bg-accent-terracotta/10 backdrop-blur-sm border border-accent-terracotta/10 rotate-[-2deg]" />
