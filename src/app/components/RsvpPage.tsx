                  ...
                  <div className="grid grid-cols-2 gap-4 md:gap-10 max-w-2xl mx-auto items-stretch">
                    {[
                      ...
                      <button
                        ...
                        className={`group relative p-6 md:p-14 border transition-all duration-700 hover:border-accent-terracotta/40 flex flex-col items-center justify-center text-center overflow-hidden ${
