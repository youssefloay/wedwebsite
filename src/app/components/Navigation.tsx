...
export function Navigation() {
  ...
  return (
    <>
      ...
      <nav className="fixed bottom-0 inset-x-0 z-[100] pb-4 md:pb-8 px-4 pointer-events-none">
         {/* The Unified Navbar Container */}
        <div className="max-w-[640px] md:max-w-[920px] mx-auto pointer-events-auto">
          <div className="flex items-center justify-center gap-1 md:gap-4 h-16 md:h-18 rounded-2xl md:rounded-full border border-primary-text/5 bg-background/60 backdrop-blur-xl shadow-[0_8px_32px_rgba(92,50,16,0.08)] px-1 md:px-4 transition-all duration-500 overflow-x-auto no-scrollbar">
