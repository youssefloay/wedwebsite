...
export function GiftsPage() {
  const [revolutMode, setRevolutMode] = useState<'tag' | 'iban'>('tag');
          ...
          <div className="wedding-card bg-white border border-border/10 p-0 overflow-hidden shadow-sm hover:shadow-xl transition-all duration-1000 max-w-4xl mx-auto">
            <div className="flex border-b border-border/10 bg-[#FBF9F4] overflow-x-auto no-scrollbar">
              <button 
                ...
                className={`flex-1 min-w-[120px] py-6 text-[11px] uppercase tracking-[0.2em] font-bold transition-all ${revolutMode === 'tag' ? 'text-accent-terracotta bg-white border-b-2 border-accent-terracotta shadow-sm' : 'text-secondary-text opacity-60'}`}>
                Revolut Tag
              </button>
              <button 
                onClick={() => setRevolutMode('iban')} 
                className={`flex-1 min-w-[120px] py-6 text-[11px] uppercase tracking-[0.2em] font-bold transition-all ${revolutMode === 'iban' ? 'text-accent-terracotta bg-white border-b-2 border-accent-terracotta shadow-sm' : 'text-secondary-text opacity-60'}`}>
                Euro IBAN
              </button>
            </div>
